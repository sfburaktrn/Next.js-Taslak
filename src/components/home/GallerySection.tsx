    ...
    return (
        <section className="relative py-24 bg-black overflow-hidden">
            ...
            <div className="absolute inset-0 z-0 opacity-20">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-ozunlu-900/40 via-black to-black" />
            </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="text-center mb-12">
                    <motion.span
                        ...
                        viewport={{ once: true }}
                        className="text-white font-bold tracking-[0.2em] text-sm uppercase mb-4 block"
                    >
                        MEDYA & GALERİ
                    </motion.span>
                    <motion.h2
                    ...
                    >
                        DETAYLARDA <span className="text-white">MÜKEMMELLİK</span>
                    </motion.h2>
                </div>
                    ...
                    >
                        {galleryImages.map((image, index) => (
                            <motion.div
                                ...
                                className="relative flex-shrink-0 w-[300px] h-[400px] md:w-[400px] md:h-[500px] snap-center group rounded-2xl overflow-hidden border border-white/10"
